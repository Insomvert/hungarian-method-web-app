...
<div class="row tabb d-flex justify-content-between">
    ...
    <div class="rn active"><i class="fa fa-briefcase"></i><span class="nn">Job</span></div>
...
<form method="get" name="frm" action="">
    <label for="jumlahJ" class="ij">Masukkan Jumlah Tugas : </label>
    <input name="id" type="text" value="<?php echo $lid;?>" style="display:none">
...
<form method="post" name="frmpost" action="">
  <table cellpadding="0" cellspacing="0" class="table table-sm tcost">
    <tr>
      <td width="2px"></td>
      <td valign="top" class="jt">Nama Tugas</td>
    </tr>
<?php
...
<?php
  ...
  if(isset($_POST['btnOk'])){
    ...
    $job2 = implode(",",$job);
    $id = $_GET['id'];
    $sql = "UPDATE optimasi SET job='".$job2."' WHERE optimasi.id=".$id."";
    mysqli_query($con,$sql);
    header('Location:cost.php?id='.$id);
  }
  ob_end_flush();
?>