...
class Hungarian
{
    ...
    {
        $print ? $this->printMatrix($this->matrix, '<br>Original cost matrix: <br>') : null;
        /*
         * Preliminary Steps:
         ...
         */
        $this->reduce();
        $print ? $this->printMatrix($this->reduced, '<br><br>Reduced cost matrix:<br>') : null;
        foreach ($this->reduced as $row => $cells) {
        ...
        $print ? $this->printMatrix($this->reduced, '<br><br>Final preliminary reduced cost matrix:<br>') : null;
        ...
        while ($non_covered_zero_matrix) {
            ...
            $print ? $this->printMatrix($this->reduced, '<br><br>Reduced cost matrix of non-covered zero iteration:<br>') : null;
