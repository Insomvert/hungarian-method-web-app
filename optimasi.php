...
//var_dump($cost2);
$hungarian  = new \RPFK\Hungarian\Hungarian($cost2);
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="simpan">Info Data</h5>
                    ...
                    <form action="data.php" method="POST">
                        ...
                        <label for="nData">Nama data</label>
                        <input name="nData" type="text" class="in" placeholder="masukkan nama data"  required/>
                        <label for="keterangan">Keterangan</label>
                        <textarea class="in" name="keterangan" placeholder="Keterangan data"></textarea>
                    </div>
...
<script>
		var tds = document.getElementById('countit').getElementsByTagName('td');
            ...
            document.getElementById('countit').innerHTML += '<tr><td></td><td></td><th>Total Biaya</th><th>' + sum + '</th></th>';
</script>
<script>
    $(document).ready(function() {
        $("#print").click(function(e) {
            ...
            a.click();
            var r = confirm("Data disimpan ke komputer.\nAnda ingin membuat data baru ?");
            if (r == true){
